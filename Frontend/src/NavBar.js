      ...
      <Container style={{ display: 'flex', alignItems: 'center' }}>
        ...
        <div style={{ float: 'none', display: 'flex', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
          <Form className="d-flex justify-content-center">
            ...
            <Button variant="outline-light" className="px-2" style={{ backgroundColor: '#FB723F',  borderRadius: '20px' }}><Search /></Button>
          </Form>
        </div>
        <div style={{ float: 'right', display: 'flex', alignItems: 'center' }}>
          <Button variant="outline-light" className="px-2" style={{ backgroundColor: '#1F2229' }}>
